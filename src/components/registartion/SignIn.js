        ...
        <>
            ...
            <div className="for-bg-image" style={{ backgroundImage: `url('${signUpBg}')` }}>
                <div className="for-bg-color">
                    <div className='back'><Link to="/OPI_proj/"><BsArrowLeftShort />Home</Link></div>
                    <div className="container">
                        ...
                        >
                            <div className="register-page">
                                <div className="box">
                                    <div className='links'>
                                        <button><Link to="/OPI_proj/sign-up">Sign In</Link></button>
                                    </div>
                                    <div className="reg-box">
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <p className='forgot'><Link to="/OPI_proj/reset-password">Forgot Password?</Link></p>
                                            {!state.loading ?
                                                <button>
                                            ...
                                            <p className='already'>You need Account? <span><Link to="/OPI_proj/sign-up">Sign Up</Link></span></p>
                                        </form>
                                    </div>
                                </div>
                            </div>
